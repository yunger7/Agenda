...
<body style="width: initial; height: initial; overflow: initial;">
  ...
  <main class="mt-4 mx-5 d-flex align-items-start justify-content-around">
    <section id="cadastro" class="w-25 mx-3 position-relative d-flex flex-column align-items-center justify-content-center">
      ...
      <form action="config/cadusuario.php" method="POST" class="p-5 w-100 bg-light my-3 d-flex flex-column" style="max-width: 600px; border-radius: 15px;">
        ...
        <button type="submit" class="btn btn-info w-75 mx-auto mt-4" style=" max-width: 200px;">Cadastrar usuário</button>
      </form>
    </section>
    <section id="usuarios-cadastrados" class="w-75 mx-5 position-relative d-flex flex-column align-items-center justify-content-center">
        ...
        <tbody>
          <?php foreach ($usuarios as $usuario) : ?>
            <tr>
              ...
              <td>
                <a href="config/editar-usuario.php?id=<?php echo $usuario['id']; ?>" class="btn btn-info">Editar</a>
